...
## Link to Markdown file for this document

The plain text R Markdown version of this document is at [this link](https://raw.githubusercontent.com/THOMASELOVE/431-2018-data/master/431-getting-started-with-R.Rmd), or you can find it on our [Data page](https://github.com/THOMASELOVE/431-2018-data).

\newpage

# Purpose of this Document

This is meant to walk you through the steps of completing some elementary analyses using R, R Studio, and R Markdown. Working through this document will definitely help you get rolling on our homework assignments.

## Preliminary Steps

1. Follow the [instructions to install R, R Studio and the R packages and data and code that we'll use in 431](https://github.com/THOMASELOVE/431-2018/blob/master/software/installation.md). Once you have these things installed, you're ready for the steps below.
2. Select or create a subdirectory on your computer for your project. We'll call that your **project folder**.
    ...
    + A good directory path might be something like `pqhs431/2018-09-01_my-first-R-project`
